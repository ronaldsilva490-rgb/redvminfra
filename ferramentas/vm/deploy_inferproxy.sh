...
INFERPROXY_AUTO_BETA_HEADERS=${INFERPROXY_AUTO_BETA_HEADERS}
INFERPROXY_FILE_STORE_PATH=${INFERPROXY_FILE_STORE_PATH}
INFERPROXY_FILE_UPLOAD_MAX_BYTES=${INFERPROXY_FILE_UPLOAD_MAX_BYTES}
