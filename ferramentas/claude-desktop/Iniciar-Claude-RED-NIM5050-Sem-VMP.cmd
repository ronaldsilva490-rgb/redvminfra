...
title Claude RED - NIM Claude 5050
...
set "CHAT_FIX=%~dp0Preparar-Claude-RED-NIM5050.ps1"
if not exist "%CHAT_FIX%" set "CHAT_FIX=C:\Projetos\redvm\ferramentas\claude-desktop\Preparar-Claude-RED-NIM5050.ps1"
...
if errorlevel 1 (
  echo.
  echo Falha ao configurar o Claude para o RED NIM Claude :5050.
  pause
  exit /b 1
)
