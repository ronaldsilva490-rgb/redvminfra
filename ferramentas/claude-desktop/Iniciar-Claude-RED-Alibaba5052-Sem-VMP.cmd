...
title Claude RED - Alibaba Claude 5052
...
set "CHAT_FIX=%~dp0Preparar-Claude-RED-Alibaba5052.ps1"
if not exist "%CHAT_FIX%" set "CHAT_FIX=C:\Projetos\redvm\ferramentas\claude-desktop\Preparar-Claude-RED-Alibaba5052.ps1"
...
if errorlevel 1 (
  echo.
  echo Falha ao configurar o Claude para o RED Alibaba Claude :5052.
  pause
  exit /b 1
)
