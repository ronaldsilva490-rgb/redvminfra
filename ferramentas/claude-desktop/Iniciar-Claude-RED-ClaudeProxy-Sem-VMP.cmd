...
set "CHAT_FIX=%~dp0Preparar-Claude-RED-ClaudeProxy.ps1"
if not exist "%CHAT_FIX%" set "CHAT_FIX=C:\Projetos\redvm\ferramentas\claude-desktop\Preparar-Claude-RED-ClaudeProxy.ps1"
...
if errorlevel 1 (
  echo.
  echo Falha ao configurar o Claude para o redclaudeproxy.
  pause
  exit /b 1
)
