...
title Claude RED - Lightning Claude 5051
...
set "CHAT_FIX=%~dp0Preparar-Claude-RED-Lightning5051.ps1"
if not exist "%CHAT_FIX%" set "CHAT_FIX=C:\Projetos\redvm\ferramentas\claude-desktop\Preparar-Claude-RED-Lightning5051.ps1"
...
if errorlevel 1 (
  echo.
  echo Falha ao configurar o Claude para o RED Lightning Claude :5051.
  pause
  exit /b 1
)
