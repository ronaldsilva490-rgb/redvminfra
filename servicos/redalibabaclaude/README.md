...
- se o upstream encerrar uma rodada entregando apenas `reasoning_content`, sem texto visivel e sem tool call, o gateway faz uma rodada interna de reparo para forcar resposta visivel ou chamada de ferramenta. O limite e `REDALIBABACLAUDE_EMPTY_OUTPUT_REPAIR_MAX_ROUNDS=2`; se persistir, o cliente recebe uma mensagem visivel em vez de uma conclusao silenciosa.
