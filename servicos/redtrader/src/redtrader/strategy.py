...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "iqoption_gale_max_amount": 25,
    "iqoption_stake_mode": "percentage",
    ...
    "analysis_cooldown_seconds": 1.5,
    "news_poll_seconds": 300,
    "cooldown_minutes": 30,
    "max_trades_per_day": 3,
    "max_open_positions": 1,
    "initial_balance_brl": 100.0,
    "position_pct": 20.0,
...
RISK_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "full_aggressive": {
        ...
        "settings": {
            ...
            "analysis_cooldown_seconds": 0.75,
            "market_poll_seconds": 0.25,
