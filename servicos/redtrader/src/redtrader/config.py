...
class Settings:
    ...
    iq_bridge_url = _env("REDTRADER_IQ_BRIDGE_URL", "http://127.0.0.1:3115").rstrip("/")
    iq_bridge_token = _env("REDTRADER_IQ_BRIDGE_TOKEN", "")
    iq_bridge_session_id = _env("REDTRADER_IQ_BRIDGE_SESSION_ID", "")
    iq_bridge_poll_ms = int(_env("REDTRADER_IQ_BRIDGE_POLL_MS", "500"))
    iq_bridge_timeout_seconds = float(_env("REDTRADER_IQ_BRIDGE_TIMEOUT_SECONDS", "2.5"))
